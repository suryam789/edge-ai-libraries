...
export const SplitmuxsinkNodeWidth = 180;
  ...
  <div className="px-4 py-2 shadow-md rounded-md bg-white border-2 border-sky-400 min-w-40">
    <div className="flex flex-col">
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="text-lg font-bold text-sky-700">Splitmuxsink</div>
      ...
      {/* Description */}
      <div className="text-xs text-gray-600">File splitting muxer sink</div>
    </div>
